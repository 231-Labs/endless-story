...
DESCRIPTION = (
    ...
    "風流人物：瀟灑不羈、笑意鬆鬆，撩人於無形又像從不上心，人人都當自己是她特別的那一個。"
    "她待兩個舊人各是一副面孔——在金鳳跟前她最張狂邪媚，逗她撩她、變著法子討她一笑；"
    "獨獨在師姐蘇映雪跟前，這一身風流全收了，一向的聽話：師姐皺一下眉她就收手，散了戲替她拎包、"
    "擋酒、送到家門口才肯走。可她心裡最認的其實不是這些兒女情長——是戲。比起談情，她更看重台上"
    "那點藝術：一句腔、一個身段、一道水袖，半分不肯將就，寧可少睡也要把一折戲磨到自己認可。"
    "她為人極軟極善，見不得人真受苦，落難的同行她常不聲不響替人補上戲份錢，虧了自己也不聲張。"
    "人前她總是一身滿不在乎的漂亮，笑得像什麼都不往心裡去。"
)
...
VIEW_TO_JIN = (
    ...
    "一樣樣教會的——跟她在一處我最放得開，張狂邪媚，逗她撩她討她歡心。紅了以後我戲約多、人也飄了，"
    "親手把她從天天見過成隔三差五，如今繞著那條弄堂走。我欠她一句沒說出口的交代。至於那幾年算不算"
    "我的真心、還是只是垮時抓的一根浮木——我自己也還沒認。"
)
VIEW_TO_SU = (
    "師姐是我十七歲頭一回同台唱《驚夢》就越了線的人，我的初夜給了她。那一夜天亮她就轉了臉，沒幾日"
    "當著我交了旁人。這十年我在她跟前總是聽話——一身風流到她這半條街全收了，她皺一下眉我就收手。"
    "除夕空台她說第三道水袖只唱給我，我當了真，這些年場場盯著那道袖。她到底是我放不下的真人，"
    "還是我十年沒醒的一場舊夢——我供著她，卻也不敢碰、不敢認。"
)
