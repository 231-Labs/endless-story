...
export const PROMPT_LAB_CALLS: PromptLabCallDefinition[] = [
    ...
    },
    {
        ...
        defaultInput: {
            ...
            roster: [
                { id: '0xmeng', name: '孟雲屏', role: '花旦', gender: '女', ageYears: 24, brief: '班裡頭牌花旦' },
                { id: '0xgu', name: '顧驚鴻', role: '小生', gender: '女', ageYears: 23, brief: '與孟雲屏常搭戲的女小生' },
            ],
        },
    },
    {
        ...
        defaultInput: {
            ...
            physicalFacts: '廿二歲，短髮束於腦後，眉如墨畫，肩線清瘦；右耳後一痣。',
            description: '外地來的女小生，台上英氣，台下怕冷，總把一枚舊銅錢縫在袖口。',
            privateBackstory: '其實她離開舊班不是為了闖名聲，而是怕自己一輩子只被當成替補；袖口那枚舊銅錢，是師姐臨別前替她縫上的。',
            recruitmentRoleIntent: '能與花旦搭戲、又能在後台製造競爭張力的小生。',
            mode: 'newcomer',
            count: 8,
            roster: [
