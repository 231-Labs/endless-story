/**
 * Proves forcing is an event-driven accumulator, structurally incapable of being a
 * tick timer (§4d.2).
 *
...
test('④ 世界收手 → 壓力回落、arc 重新可拖', () => {
    ...
    for (let i = 0; i < 12; i += 1) arc = accumulate(arc, 0);
