...
export const UNIVERSAL_PORTRAIT_TONE =
  '淡彩水墨工筆肖像：淡墨細線勾勒，清透水彩薄塗，設色清淡通透，大面積留白，宣紙暈染質感；統一純白背景，五官自然有辨識度，民國上海氣質只見於髮型與常服。';

export const UNIVERSAL_PORTRAIT_GUARD =
  '素顏頭肩半身、四分之三側面 45°、純白背景、自然光；全圖淡彩薄塗、筆觸鬆透、留白為主，五官平實有記憶點，保留年齡與生活痕跡；民國上海梨園後台髮型與素常服，畫面只有人物，無文字、印章、票券、道具與邊框。';
...
目標不是俊男美女海報，而是可長期追蹤的「真人有辨識度」角色臉：比例端正、乾淨、自然，
但保留年齡、疲憊、個性與一點不對稱；不要把所有人修成同一張漂亮臉。
