...
export const UNIVERSAL_PORTRAIT_TONE =
  '淡彩水墨工筆肖像：淡墨細線勾勒，清透水彩薄塗，設色清淡通透，大面積留白，宣紙暈染質感；統一純白背景，五官清秀端正且有辨識度，民國上海氣質只見於髮型與常服。';

export const UNIVERSAL_PORTRAIT_GUARD =
  '素顏頭肩半身、四分之三側面 45°、純白背景、自然光；全圖淡彩薄塗、筆觸鬆透、留白為主，五官清秀耐看、有記憶點，保留年齡與個性痕跡；民國上海梨園後台髮型與素常服，畫面只有人物，無文字、印章、票券、道具與邊框。';
...
目標是可長期追蹤、讓人願意凝視的角色臉：清秀端正、乾淨耐看、帶舞台氣質，
同時保留年齡、個性與一點不對稱；不要把所有人修成同一張漂亮臉，也不要刻意寫醜。
...
- 髮型只取民國上海梨園後台：女子低髻、齊耳短髮、側分短髮或簡潔束髮；男子側分短髮、
  學生式短髮或樸素束髮。不得使用古代高髻、仙俠髮飾、點翠頭面、現代油頭、剃邊潮流短髮、
  商務髮型或當代潮流髮型。
...
- 「女小生 / 女武生 / 坤生」（女演員扮男角）→ 性別仍是女、但臉型可微帶英氣，
  髮型用民國短髮或簡潔束髮、衣著中性（棉布短衫）。**不寫嫵媚、不寫脂粉、不寫水袖**。
