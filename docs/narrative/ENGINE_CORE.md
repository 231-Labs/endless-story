...
| `reputation.ts` | 口碑帳：別人握著的事實、知情者名單、關掉被欠那家的賒帳門——讓「打死不還」有代價而不必強制扣款 |
...
**一條後來補上的鐵律**：外力層可以製造壓力、可以讓後果不可逆，但**不得代替角色做
選擇**。月半結帳最初會強制扣款，那讓「打死不還」變成演不出來的立場；改成只叫帳、
由債主決定聲量、由口碑帳承擔後果之後，錢只在角色自己 `repay` 時才動。壓力歸引擎，
選擇歸角色，後果歸社會。
